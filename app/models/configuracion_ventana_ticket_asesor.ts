// app/models/configuracion_ventana_ticket_asesor.ts
...
export default class ConfiguracionVentanaTicketAsesor extends BaseModel {
  public static table = 'configuracion_ventana_ticket_asesores'
  ...
  declare minutosVentana: number | null
